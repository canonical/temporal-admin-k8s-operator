# Security Policy — Charmed Temporal Admin

## Reporting a Vulnerability

The easiest way to report a security issue is through a [GitHub Private Security Report](https://github.com/canonical/temporal-admin-k8s-operator/security/advisories/new) with a description of the issue, the steps you took to create the issue, affected versions, and, if known, mitigations for the issue.
...
Charmed Temporal Admin follows Canonical's standard charm support lifecycle, aligned with the Ubuntu LTS base.

| Track | Ubuntu Base | Status | End of Standard Support |
|-------|-------------|--------|------------------------|
| 1.23/stable | Ubuntu 24.04 LTS (Noble) | **Active** | April 2029 |
...
Vulnerabilities are tracked via [GitHub Security Advisories](https://github.com/canonical/temporal-admin-k8s-operator/security/advisories) and coordinated internally with Canonical's Product Security Incident Response Team (PSIRT).

Note that this charm packages the upstream [Temporal Admin Tools](https://github.com/temporalio/temporal). Vulnerabilities in the upstream tools themselves should be reported to the Temporal project directly; Canonical will track and apply upstream fixes to supported tracks.
